...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 26, 2023 at 12:14 PM
...
(14, 'Prakash Bhattarai', '9802851472', 'Pokhara-16, Dhikidada', 'Hari Bahadur', 'Pumdikot, Pokhrara'),
(15, 'KIRAN', '1236547897', 'BHADRAPUR 7, JHAPA', 'Pawan', 'BHADRAPUR 7, JHAPA');
...
(3, 4726.8, '2023-07-24', 14, 5252, 525.2),
(4, 54, '2023-07-25', 15, 60, 6);
...
(6, 'Paracetamol', '5/20', 'Citamol', 'Fndn'),
(7, 'Metronidazole', '5/23', 'METRONIDAZOLE', 'Kiran Pharma');
...
(1, 'Crosin', 'CROS12', '12/34', 50, 2626, 26),
(2, 'Gelusil', 'G327', '12/42', 0, 15, 12),
(3, 'Dolo 650', 'DOLO327', '01/27', 1, 30, 24),
...
('Fndn', 123, 1, '2023-07-24', 1500, 'DUE'),
('Kiran Pharma', 12, 2, '2023-07-24', 3500, 'PAID');
...
INSERT INTO `sales` (`SALE_ID`, `INVOICE_NUMBER`, `MEDICINE_NAME`, `EXPIRY_DATE`, `QUANTITY`, `MRP`, `DISCOUNT`, `TOTAL`, `CUSTOMER_ID`) VALUES
(1, 3, 'Xyz', '0000-00-00', 5, 120.00, 10.00, 110.00, 14);
...
--
ALTER TABLE `sales`
  ADD CONSTRAINT `sales_ibfk_1` FOREIGN KEY (`INVOICE_NUMBER`) REFERENCES `invoices` (`INVOICE_ID`),
